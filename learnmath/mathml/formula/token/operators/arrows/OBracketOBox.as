...
public class OBracketOBox extends OBox{

	private var k:Number = 0.1;
	private var l:Number = 0.1;
	private var wl:Number = 1;

	public function	OBracketOBox(parentBox:Box):void{
		super(parentBox);
	}
	...
	override public function draw(graph:MovieClip):void{
		...
		graph.graphics.moveTo(finalBounds.x + wl, finalBounds.y + finalBounds.height*0.8);
		graph.graphics.lineTo(finalBounds.x + wl, finalBounds.y + finalBounds.height*0.5);
		graph.graphics.lineTo(finalBounds.x+finalBounds.width-wl, finalBounds.y + finalBounds.height*0.5);
		graph.graphics.lineTo(finalBounds.x+finalBounds.width-wl, finalBounds.y + finalBounds.height*0.8);
