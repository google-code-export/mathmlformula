...
public class SmileOBox extends OBox{

	private var k:Number = 0.1;
	private var l:Number = 0.1;
	private var wl:Number = 1;

	public function	SmileOBox(parentBox:Box):void{
		super(parentBox);
	}
	...
	override public function draw(graph:MovieClip):void{
		...
		graph.graphics.curveTo(finalBounds.x+finalBounds.width/2, finalBounds.y + finalBounds.height, finalBounds.x+finalBounds.width, finalBounds.y+ finalBounds.height*0.6);
	}
