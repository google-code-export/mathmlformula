...
public class UBracketOBox extends OBox{

	private var k:Number = 0.1;
	private var l:Number = 0.1;
	private var wl:Number = 1;

	public function	UBracketOBox(parentBox:Box):void{
		super(parentBox);
	}
	...
	override public function draw(graph:MovieClip):void{
		...
		graph.graphics.moveTo(finalBounds.x + wl, finalBounds.y + finalBounds.height*0.2);
		...
		graph.graphics.lineTo(finalBounds.x+finalBounds.width-wl, finalBounds.y + finalBounds.height*0.2);
	}
